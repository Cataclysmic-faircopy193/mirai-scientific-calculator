  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=default]/tabs-list:hover:bg-foreground/8 group-data-[variant=default]/tabs-list:hover:text-foreground group-data-[variant=default]/tabs-list:data-active:hover:bg-background group-data-[variant=line]/tabs-list:hover:bg-transparent",
